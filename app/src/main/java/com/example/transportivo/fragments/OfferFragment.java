...
public class OfferFragment extends BaseFragment {
    ...
    protected View initializeView(View view) {
        ...
        firebaseClient.getAll(Offer.class, entities -> System.out.println("Number of offers: " + entities.length));

        firebaseClient.getOne(Offer.class, "rqDp7Lft9iXMFTszvPhh", result -> System.out.println("Offer (getOne): " + result));
